...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        //Functions to control the aeroplane
        ...
        //ROLL means turning left or right, PITCH is going up or down.
        ...
        //Constants to determine the aeroplane's character
        ...
        private Quaternion m_OriginalRotation;     // The rotation when the scene starts.
        ...
        private void Start()
        {
            ...
            transform.Rotate(random.Next(0, 360), random.Next(0, 360), random.Next(0, 360));
        ...
        private double getValue(Dictionary<string, double> map, string value)
        {
            return map[value];
        }
        ...
        private void CalculateForwardSpeed()
        {
            ...
            //Debug.Log ("ForwardSpeed: " + ForwardSpeed.ToString());
        }
